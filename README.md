...
| CaDSI [31] | Hybrid | Model-specific | Node level | https://github.com/AlfredYuisGood/CaDSI-Implementation-Code |
| SEV-RS [32] | Path-based | Model-specific | Implicit | - |
| CGSR [33] | Embedding-based | Model-specific | Implicit | - |
| CGSR [34] | Embedding-based | Model-specific | Node and path levels | - | 
...
[31] Xiangmeng Wang, Qian Li, Dianer Yu, Peng Cui, Zhichao Wang, and Guandong Xu. 2022. Causal disentanglement for semantics-aware intent learning in recommendation. IEEE Transactions on Knowledge and Data Engineering (2022).

[32] Thanet Markchom, Huizhi Liang, and James Ferryman. 2023. Scalable and explainable visually-aware recommender systems. Knowledge-Based Systems 263 (2023), 110258.

[33] Dianer Yu, Qian Li, Hongzhi Yin, and Guandong Xu. 2023. Causality-guided graph learning for session-based recommendation. In Proceedings of the 32nd ACM International Conference on Information and Knowledge Management. 3083–3093.
